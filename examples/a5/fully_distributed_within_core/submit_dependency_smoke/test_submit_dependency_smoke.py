...
class TestSubmitDependencySmoke(SceneTestCase):
    ...
    CASES = [
        ...
        {
            "name": "A5SimMaxBdOverlapSubView",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 1},
        },
        {
            "name": "A5OnboardMaxBdOverlapSubView",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 1},
        ...
        {
            "name": "A5SimMaxBdExistingInoutChain",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 2},
        },
        {
            "name": "A5OnboardMaxBdExistingInoutChain",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 2},
        ...
        {
            "name": "A5SimMaxBdSubViewOnly",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 3},
        },
        {
            "name": "A5OnboardMaxBdSubViewOnly",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 3},
        ...
        {
            "name": "A5SimMaxBdScalarOffsetOnly",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 4},
        },
        {
            "name": "A5OnboardMaxBdScalarOffsetOnly",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 4},
        ...
        {
            "name": "A5SimMaxBdInspectSubView",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 5},
        },
        {
            "name": "A5OnboardMaxBdInspectSubView",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 5},
        ...
        {
            "name": "A5SimMaxBdInspectLocalCopy",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 6},
        },
        {
            "name": "A5OnboardMaxBdInspectLocalCopy",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 6},
        ...
        {
            "name": "A5SimMaxBdAllocDescriptor",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 7},
        },
        {
            "name": "A5OnboardMaxBdAllocDescriptor",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 7},
        ...
        {
            "name": "A5SimMaxBdAllocFillFanin",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 8},
        },
        {
            "name": "A5OnboardMaxBdAllocFillFanin",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 8},
        ...
        {
            "name": "A5SimMaxBdLeftOutputFanin",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 9},
        },
        {
            "name": "A5OnboardMaxBdLeftOutputFanin",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 9},
        ...
        {
            "name": "A5SimMaxBdRightOutputFanin",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 10},
        },
        {
            "name": "A5OnboardMaxBdRightOutputFanin",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 10},
        ...
        {
            "name": "A5SimMaxBdTaskOutputViewFanin",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 15},
        },
        {
            "name": "A5OnboardMaxBdTaskOutputViewFanin",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 15},
        ...
        {
            "name": "A5SimMaxBdDelayedRingFanout",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 257, "mode": 16},
        },
        {
            "name": "A5OnboardMaxBdDelayedRingFanout",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 257, "mode": 16},
        ...
        {
            "name": "A5SimMaxBdAicConsumesAivOutput",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 17},
        },
        {
            "name": "A5OnboardMaxBdAicConsumesAivOutput",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 17},
        ...
        {
            "name": "A5SimMaxBdFaninRingReuseStress",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 512, "mode": 29},
        },
        {
            "name": "A5OnboardMaxBdFaninRingReuseStress",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 512, "mode": 29},
        ...
        {
            "name": "A5SimMaxBdFaninLargeStress",
            "manual": True,
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
        ...
        {
            "name": "A5OnboardMaxBdFaninLargeStress",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 30},
        ...
        {
            "name": "A5SimMaxBdL0TaskArgsTagPersistence",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 14},
        },
        {
            "name": "A5OnboardMaxBdL0TaskArgsTagPersistence",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 14},
        ...
        {
            "name": "A5SimMaxBdAllocFillRunAhead1",
            "platforms": ["a5sim"],
            "config": {
                "aicpu_thread_num": 4,
                "runtime_env": {"ring_heap": 68 * 1024},
        ...
        {
            "name": "A5OnboardMaxBdAllocFillRunAhead1",
            "manual": True,
            "platforms": ["a5"],
            "config": {
                "aicpu_thread_num": 4,
        ...
        {
            "name": "A5SimMaxBdDelayedRegionRegister",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 32},
        },
        {
            "name": "A5SimMaxBdDelayedSharedOutputExisting",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 33},
        },
        {
            "name": "A5SimMaxBdLongInoutViewChain",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 34},
        },
        {
            "name": "A5OnboardMaxBdLongInoutViewChain",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 34},
        ...
        {
            "name": "A5SimMaxBdMixedFreshAndInoutDeps",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 35},
        },
        {
            "name": "A5OnboardMaxBdMixedFreshAndInoutDeps",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 4096, "mode": 35},
