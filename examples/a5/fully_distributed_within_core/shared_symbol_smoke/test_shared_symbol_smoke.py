...
class TestSharedSymbolSmoke(SceneTestCase):
    ...
    CASES = [
        {
            "name": "A5SimMaxBdAicToAivSymbol",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 0},
        },
        {
            "name": "A5SimMaxBdAivToAicSymbol",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 1},
        },
        {
            "name": "A5SimMaxBdAicPairSlot1ToAivSymbol",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 2},
        },
        {
            "name": "A5OnboardMaxBdAicPairSlot1ToAivSymbol",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 2},
        ...
        {
            "name": "A5SimMaxBdAivPairSlot1ToAicSymbol",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 3},
        },
        {
            "name": "A5SimMaxBdPaddedShardSlot1Symbol",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 4},
        },
        {
            "name": "A5OnboardMaxBdPaddedShardSlot1Symbol",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 4},
        ...
        {
            "name": "A5SimMaxBdAicPairSlot1ToDualAivSymbol",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 5},
        },
        {
            "name": "A5OnboardMaxBdAicPairSlot1ToDualAivSymbol",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 5},
        ...
        {
            "name": "A5SimMaxBdDualAivPairSlot1ToAicSymbol",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 6},
        },
        {
            "name": "A5OnboardMaxBdDualAivPairSlot1ToAicSymbol",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4},
            "params": {"n": 128, "mode": 6},
