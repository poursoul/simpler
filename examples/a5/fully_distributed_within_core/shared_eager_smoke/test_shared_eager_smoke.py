...
# -----------------------------------------------------------------------------------------------------------
"""Shared TensorMap eager-submit smoke test."""
...
class TestSharedEagerSmoke(SceneTestCase):
    RTOL = 0
    ATOL = 0
    ...
    CALLABLE = {
        "orchestration": {
            "source": "../simple_orch_smoke/kernels/orchestration/simple_orch.cpp",
        ...
        "incores": [
            {
                "func_id": 0,
                "name": "MARK_AIC",
                "source": "../simple_orch_smoke/kernels/aic/mark_core.cpp",
                "core_type": "aic",
                "signature": [D.IN, D.INOUT],
            },
            {
                "func_id": 1,
                "name": "MARK_AIV",
                "source": "../simple_orch_smoke/kernels/aiv/mark_core.cpp",
                "core_type": "aiv",
                "signature": [D.IN, D.INOUT],
            },
        ],
    ...
    CASES = [
        {
            "name": "A5SimBd1SingleDelta7",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4, "block_dim": 1},
            "params": {"n": 1, "delta": 7, "mixed": 0},
        },
        {
            "name": "A5OnboardBd1SingleDelta7",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4, "block_dim": 1},
            "params": {"n": 1, "delta": 7, "mixed": 0},
        ...
        {
            "name": "A5SimBd1TwoTasksDelta7",
            "platforms": ["a5sim"],
            "config": {"aicpu_thread_num": 4, "block_dim": 1},
            "params": {"n": 2, "delta": 7, "mixed": 0},
        },
        {
            "name": "A5OnboardBd1TwoTasksDelta7",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4, "block_dim": 1},
            "params": {"n": 2, "delta": 7, "mixed": 0},
        ...
        {
            "name": "A5OnboardBd36RepeatedMixedDelta29",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4, "block_dim": 36},
            "params": {"n": 9, "delta": 29, "mixed": 1},
    ...
    def generate_args(self, params):
        ...
        return TaskArgsBuilder(
            ...
            Tensor("output", torch.full((n * 16,), -1.0, dtype=torch.float32)),
            Scalar("n", n),
            Scalar("delta", int(params["delta"])),
            Scalar("mixed", int(params["mixed"])),
        )
