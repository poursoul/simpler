...
临时布局控制并闭合 CPU/CCEC/A5 正确性。相对重建 `319077a9` 的
六区组布局成本配对为 4/6 更快，中位数 `-12.1595us/-0.5136%`；
该结果不单独决定保留或取消 S4.16b。S4.16b 已在同址布局中启用
全部十六条线并闭合 CPU/CCEC/A5 b1 正确性，尚未冻结或比较性能。
...
布局整体。S4.16b 已按同址单变量实现并闭合正确性，尚无冻结性能结果；
不得把 S4.16a 配对或 b1 功能时间冒充 active16 收益。
